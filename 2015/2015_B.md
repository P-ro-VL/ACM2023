...
Sau đó sử dụng thuật toán KMP để đếm số lần xuất hiện của $t$ trong $s$ đã cho. Giả sử số lần xuất hiện là $m$, ta sẽ kiểm tra nốt $s.length() - z.k$ phần tử cuối cùng của dãy $s$ xem có khớp với phần đầu hoặc hoàn toàn chuỗi $t$ hay không.
